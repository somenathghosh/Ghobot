...
var ChatBot = (function ($) {
    ...
    function updateCommandDescription() {
        ...
        for (i = 0; i < engines.length; i++) {
            engines[i].getCapabilities(function(data){
              for (j = 0; j < data.length; j++) {
                  descriptions.push(data[j]);
              }
            });
    ...
    return {
                ...
                react: function (query,callback) {
                      ...
                      $.ajax({
                          ...
                          success: function(data) {
                              ...
                              callback(content,suggestion, 'bot');
        ...
        react: function react(text) {
            this.thinking(true);
            engine.react(text,function(err,res,sug){
              this.addChatEntry(res,sug);
            });
        ...
        getCapabilities: function capabilities(callback){
          engine.getCapabilities(callback);
        },
